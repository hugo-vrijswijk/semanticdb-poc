...
object Main extends App {
  private val scalaLibJar =
    (File.home / ".cache/coursier/v1/https/repo1.maven.org/maven2/org/scala-lang/scala-library/2.12.8/scala-library-2.12.8.jar").path
...
//  File(
//    "../semanticdb-example/target/scala-2.12/classes/META-INF/semanticdb/src/main/scala/example/Example.scala.semanticdb"
//  ).inputStream apply { stryker4s =>
//    val td = TextDocuments.parseFrom(stryker4s)
//    val refs = td.documents.flatMap(_.occurrences.filter(_.role.isReference))
//    println("foo")
//  }
